...
public class EMSInformationService {
	...
	private void printDBInfo() {
		Set<String> keys = dbInfors.keySet();
		Iterator<String> iterator = keys.iterator();

		while (iterator.hasNext()) {
			String key = iterator.next();
			DBConnectionInfo info = dbInfors.get(key);
	...
	public Map<String, DBConnectionInfo> getDbInfors() {
		return dbInfors;
	}

	public void setDbInfors(Map<String, DBConnectionInfo> dbInfors) {
		this.dbInfors = dbInfors;
	}
